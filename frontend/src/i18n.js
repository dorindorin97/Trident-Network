...
const resources = {
  en: {
    translation: {
      ...
      "Enter block number, transaction ID, or address": "Enter block number, transaction ID, or address",
      "Block number or hash (0x...)": "Block number or hash (0x...)",
      "Transaction hash (0x...)": "Transaction hash (0x...)",
      "Account address (T...)": "Account address (T...)",
      "Any valid block, transaction, or address": "Any valid block, transaction, or address",
      "Optional": "Optional",
      ...
      "Invalid search query format": "Invalid search query format",
      "Invalid block number or hash": "Invalid block number or hash",
